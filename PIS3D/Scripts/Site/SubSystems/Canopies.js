...
app.controller('CanopiesCtrl', function ($scope, $http,$log) {
    ...
    $scope.removeAcc = function (index) {
        ...
        $scope.Acchistory.push($scope.building.Subsystems.Canopies.Canopies[index]);
        // Remove from main records (using index)
        $scope.building.Subsystems.Canopies.Canopies.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoAcc = function () {
        $scope.building.Subsystems.Canopies.Canopies.push($scope.Acchistory[$scope.Acchistory.length - 1]);
    ...
    $scope.ResetAcc = function () {
        $scope.Accword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.Canopies.Canopies)
            id = $scope.building.Subsystems.Canopies.Canopies.length + 1;
        $scope.newobj = {
            ID: id, 
            AssignTo: "NSW", 
            Width: 1, 
            ...
            ClearHeight: 1,
            CanopyRoofSlope: 1,
            EaveCondition: {EaveConditionEnum: "EAVE GUTTER", Downspouts: "STANDARD" },
            RoofPanel: { ID: 1, Description: "OTHER" },
    ...
    $scope.AddAcc = function () {
        if ($scope.building.Subsystems.Canopies.Canopies)
            $scope.building.Subsystems.Canopies.Canopies.push(angular.copy($scope.newobj));
        else
            $scope.building.Subsystems.Canopies.Canopies = [angular.copy($scope.newobj)];
    };
    $scope.AccUpdate = function (index) {
        $scope.newobj = angular.copy($scope.building.Subsystems.Canopies.Canopies[index]);
        ...
        var RoofPanel = $scope.newobj.RoofPanel.Description.includes("-");
        if (RoofPanel || $scope.newobj.RoofPanel.Description=="")
            $scope.ByWho1 = "ZS";
        else
            $scope.ByWho1 = $scope.newobj.RoofPanel.Description;
    ...
    $scope.ModyfyAcc = function () {
        $scope.building.Subsystems.Canopies.Canopies[$scope.accIndex] = angular.copy($scope.newobj);
    };
    ...
    $scope.NSWByWhoChange = function () {
        if ($scope.ByWho1 == "ZS") {
            $scope.newobj.RoofPanel = { Description: "", Id: 1 };
        }
        else if ($scope.ByWho1 == "OTHER" || $scope.ByWho1 == "NONE") {
            $scope.newobj.RoofPanel = { Description: $scope.ByWho1, Id: 1 };
        }
    };
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.Subsystems.Canopies.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.Subsystems.Canopies.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.Canopies.Remarks.Remark)
            id = $scope.building.Subsystems.Canopies.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.Subsystems.Canopies.Remarks.Remark)
            $scope.building.Subsystems.Canopies.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.Subsystems.Canopies.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.Subsystems.Canopies.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.Subsystems.Canopies.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

...
app.controller('RoofExtensionsCtrl', function ($scope, $http,$log) {
    ...
    $scope.removeAcc = function (index) {
        ...
        $scope.Acchistory.push($scope.building.Subsystems.RoofExtensions.RoofExtensions[index]);
        // Remove from main records (using index)
        $scope.building.Subsystems.RoofExtensions.RoofExtensions.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoAcc = function () {
        $scope.building.Subsystems.RoofExtensions.RoofExtensions.push($scope.Acchistory[$scope.Acchistory.length - 1]);
    ...
    $scope.ResetAcc = function () {
        $scope.Accword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.RoofExtensions.RoofExtensions)
            id = $scope.building.Subsystems.RoofExtensions.RoofExtensions.length + 1;
    ...
    $scope.AddAcc = function () {
        if ($scope.building.Subsystems.RoofExtensions.RoofExtensions)
            $scope.building.Subsystems.RoofExtensions.RoofExtensions.push(angular.copy($scope.newobj));
        else
            $scope.building.Subsystems.RoofExtensions.RoofExtensions = [angular.copy($scope.newobj)];
    };
    $scope.AccUpdate = function (index) {
        $scope.newobj = angular.copy($scope.building.Subsystems.RoofExtensions.RoofExtensions[index]);
    ...
    $scope.ModyfyAcc = function () {
        $scope.building.Subsystems.RoofExtensions.RoofExtensions[$scope.accIndex] = angular.copy($scope.newobj);
    };
    ...
    $scope.RestSingleWallLinerNSW = function () {
        $scope.Profile = ["S", "ZW", "D", "E", "Max12", "Max18", "Max24"];
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.Subsystems.RoofExtensions.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.Subsystems.RoofExtensions.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.RoofExtensions.Remarks.Remark)
            id = $scope.building.Subsystems.RoofExtensions.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.Subsystems.RoofExtensions.Remarks.Remark)
            $scope.building.Subsystems.RoofExtensions.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.Subsystems.RoofExtensions.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.Subsystems.RoofExtensions.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.Subsystems.RoofExtensions.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

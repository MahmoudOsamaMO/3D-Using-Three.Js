...
app.controller('FasciasCtrl', function ($scope, $http,$log) {
    ...
    $scope.building = {};
    //ay hamaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    ...
    $scope.AccName = "Fascias";
    $scope.AssignTos = ["NSW", "FSW", "LEW", "REW"];
    $scope.Type = ["VERTICAL", "BOT CURV", "DBL CURV", "CEN CURV", "PARAPET", "NONE"];
    ...
    $scope.removeAcc = function (index) {
        ...
        $scope.Acchistory.push($scope.building.Subsystems.Fascias.Fascias[index]);
        // Remove from main records (using index)
        $scope.building.Subsystems.Fascias.Fascias.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoAcc = function () {
        $scope.building.Subsystems.Fascias.Fascias.push($scope.Acchistory[$scope.Acchistory.length - 1]);
    ...
    $scope.ResetAcc = function () {
        $scope.Accword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.Fascias.Fascias)
            id = $scope.building.Subsystems.Fascias.Fascias.length + 1;
        $scope.newobj = {
            ID: id,
            AssignTo: "NSW",
            Width: 1,
            ...
            Height: 1,
            Projection: 1, 
            FrontPanel: { ID: 1, Description: "OTHER" },
            SoffitPanel:{ ID: 1, Description: "NONE" },
            BackupPanel: { ID: 1, Description: "NONE" },
            ValleyGutter: true,
        };
        $scope.ByWho1 = "OTHER";
        $scope.ByWho2 = "NONE";
    ...
    $scope.AddAcc = function () {
        if ($scope.building.Subsystems.Fascias.Fascias)
            $scope.building.Subsystems.Fascias.Fascias.push(angular.copy($scope.newobj));
        else
            $scope.building.Subsystems.Fascias.Fascias = [angular.copy($scope.newobj)];
    };
    $scope.AccUpdate = function (index) {
        $scope.newobj = angular.copy($scope.building.Subsystems.Fascias.Fascias[index]);
        ...
        var FrontPanel = $scope.newobj.FrontPanel.Description.includes("-");
        if (FrontPanel || $scope.newobj.FrontPanel.Description == "")
            $scope.ByWho1 = "ZS";
        else
            $scope.ByWho1 = $scope.newobj.FrontPanel.Description;

        var SoffitPanel = $scope.newobj.SoffitPanel.Description.includes("-");
        if (SoffitPanel || $scope.newobj.SoffitPanel.Description == "")
            $scope.ByWho2 = "ZS";
        else
            $scope.ByWho2 = $scope.newobj.SoffitPanel.Description;


        var BackupPanel = $scope.newobj.BackupPanel.Description.includes("-");
        if (BackupPanel || $scope.newobj.BackupPanel.Description == "")
            $scope.ByWho3 = "ZS";
        else
            $scope.ByWho3 = $scope.newobj.BackupPanel.Description;
    ...
    $scope.ModyfyAcc = function () {
        $scope.building.Subsystems.Fascias.Fascias[$scope.accIndex] = angular.copy($scope.newobj);
    };
    ...
    $scope.AddSingleSkin = function () {
        ...
        if ($scope.SingleSkinFlag == 0)
            ...
            $scope.newobj.FrontPanel = { Description: $scope.newSkinobj.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 7)
            $scope.newobj.SoffitPanel = { Description: $scope.newSkinobj.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 10)
            $scope.newobj.BackupPanel = { Description: $scope.newSkinobj.Description, Id: 1 };
    ...
    $scope.AddTempcon = function () {
        ...
        if ($scope.SingleSkinFlag == 0)
            ...
            $scope.newobj.FrontPanel = { Description: $scope.newTempcon.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 7)
            $scope.newobj.SoffitPanel = { Description: $scope.newTempcon.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 8)
    ...
    $scope.RestSingleWallPanelNSW = function () {
        ...
        $scope.RestSingle($scope.newobj.FrontPanel);
    };
    $scope.RestTempconWallPanelNSW = function () {
        $scope.TempconType = ["TCSQ", "TCSO", "TCSM", "TCSN"];
        $scope.SingleSkinFlag = 6;
        $scope.RestTempcon($scope.newobj.FrontPanel);
    };
    ...
    $scope.RestSingleWallLinerNSW3 = function () {
        $scope.Profile = ["S", "ZW", "D", "E"];
        $scope.SingleSkinFlag = 10;
        $scope.RestSingle($scope.newobj.BackupPanel);
    };
    ...
    $scope.WallLinerNSWByWho3 = function () {
        if ($scope.ByWho3 == "NONE") {
            $scope.newobj.BackupPanel = { Description: $scope.ByWho3, ID: 1 };
        }
        else if ($scope.ByWho3 == "OTHER") {
            $scope.newobj.BackupPanel = { Description: $scope.ByWho3, ID: 1 };
        }
        else if ($scope.ByWho3 == "ZS") {
            $scope.newobj.BackupPanel = { Description: "", ID: 1 };
        }
    };
    ...
    $scope.NSWByWhoChange = function () {
        if ($scope.ByWho1 == "ZS") {
            $scope.newobj.FrontPanel = { Description: "", Id: 1 };
        }
        else if ($scope.ByWho1 == "OTHER" || $scope.ByWho1 == "NONE") {
            $scope.newobj.FrontPanel = { Description: $scope.ByWho1, Id: 1 };
        }
    };
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.Subsystems.Fascias.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.Subsystems.Fascias.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.Fascias.Remarks.Remark)
            id = $scope.building.Subsystems.Fascias.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.Subsystems.Fascias.Remarks.Remark)
            $scope.building.Subsystems.Fascias.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.Subsystems.Fascias.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.Subsystems.Fascias.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.Subsystems.Fascias.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

...
app.controller('PartitionsCtrl', function ($scope, $http,$log) {
    ...
    $scope.AccName = "Partitions";
    $scope.Type = ["LONG", "TRANS", "NONE"];
    $scope.SheetedSlides = ["ONE", "BOTH", "NONE"];
    $scope.OpenWallPurpose = ["BLOCKWALL", "ACCESS", "PRECAST PANEL", "GLAZING", "NONE"];
    $scope.EaveCond = {};
    $http({
        method: "GET",
    ...
    $scope.removeAcc = function (index) {
        ...
        $scope.Acchistory.push($scope.building.Subsystems.Partitions.Partitions[index]);
        // Remove from main records (using index)
        $scope.building.Subsystems.Partitions.Partitions.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoAcc = function () {
        $scope.building.Subsystems.Partitions.Partitions.push($scope.Acchistory[$scope.Acchistory.length - 1]);
    ...
    $scope.ResetAcc = function () {
        $scope.Accword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.Partitions.Partitions)
            id = $scope.building.Subsystems.Partitions.Partitions.length + 1;
        ...
        $scope.newobj = {
            ...
            "OpenWallLength": 1,
            "OpenWallHeight": 1,
            "OpenWallPurpose": "BLOCKWALL",
            GirtCondition:"",
            "Cladding":
                {
                    "Panel": { "ID": "1", "Description": "" },
                    "Insulation": { "ID": "1", "Description": "" }
                }
        };
        $scope.ByWho1 = "OTHER";
        $scope.ByWho2 = "NONE";
    ...
    $scope.AddAcc = function () {
        if ($scope.building.Subsystems.Partitions.Partitions)
            $scope.building.Subsystems.Partitions.Partitions.push(angular.copy($scope.newobj));
        else
            $scope.building.Subsystems.Partitions.Partitions = [angular.copy($scope.newobj)];
    };
    $scope.AccUpdate = function (index) {
        $scope.newobj = angular.copy($scope.building.Subsystems.Partitions.Partitions[index]);
        ...
        var RoofPanel = $scope.newobj.Cladding.Panel.Description.includes("-");
        if (RoofPanel || $scope.newobj.Cladding.Panel.Description == "")
            $scope.ByWho1 = "ZS";
        else
            $scope.ByWho1 = $scope.newobj.Cladding.Panel.Description;

        var SoffitPanel = $scope.newobj.Cladding.Insulation.Description.includes("-");
        if (SoffitPanel || $scope.newobj.Cladding.Insulation.Description == "")
            $scope.ByWho2 = "ZS";
        else
            $scope.ByWho2 = $scope.newobj.Cladding.Insulation.Description;
    ...
    $scope.ModyfyAcc = function () {
        $scope.building.Subsystems.Partitions.Partitions[$scope.accIndex] = angular.copy($scope.newobj);
    };
    ...
    $scope.AddSingleSkin = function () {
        ...
        if ($scope.SingleSkinFlag == 0)
            $scope.building.RoofWallCladding.Cladding.Panel.Panel.PanelProfile = { Description: $scope.newSkinobj.Description, Id: IDc };
            ...
            $scope.newobj.Cladding.Panel = { Description: $scope.newSkinobj.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 7)
            $scope.newobj.Cladding.Insulation = { Description: $scope.newSkinobj.Description, Id: 1 };
    ...
    $scope.AddTempcon = function () {
        ...
        if ($scope.SingleSkinFlag == 0)
            ...
            $scope.newobj.Cladding.Panel = { Description: $scope.newTempcon.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 7)
            $scope.newobj.Cladding.Insulation = { Description: $scope.newTempcon.Description, Id: 1 };
        else if ($scope.SingleSkinFlag == 8)
    ...
    $scope.AddInsulation = function () {
        ...
        if ($scope.InsulationFlag == 0)
            $scope.newobj.Cladding.Insulation = { Description: $scope.newIns.Description, Id: 1 };
    ...
    $scope.RestInsulationRoof = function () {
        ...
        $scope.RestInsulation($scope.newobj.Cladding.Insulation);
    };
    $scope.RestSingleWallPanelNSW = function () {
        $scope.Profile = ["S", "ZW"];
        $scope.SingleSkinFlag = 6;
        $scope.RestSingle($scope.newobj.Cladding.Panel);
    };
    $scope.RestTempconWallPanelNSW = function () {
        $scope.TempconType = ["TCSQ", "TCSO", "TCSM", "TCSN"];
        $scope.SingleSkinFlag = 6;
        $scope.RestTempcon($scope.newobj.Cladding.Panel);
    };

    $scope.RestSingleWallLinerNSW = function () {
        $scope.Profile = ["S", "ZW", "D", "E"];
        $scope.SingleSkinFlag = 7;
        $scope.RestSingle($scope.newobj.Cladding.Insulation);
    };
    $scope.RestTempconWallLinerNSW = function () {
        $scope.TempconType = ["TCSQ", "TCSO", "TCSM", "TCSN"];
        $scope.SingleSkinFlag = 7;
        $scope.RestTempcon($scope.newobj.Cladding.Insulation);
    };
    ...
    $scope.WallLinerNSWByWho = function () {
        if ($scope.ByWho2 == "NONE") {
            $scope.newobj.Cladding.Insulation = { Description: $scope.ByWho2, ID: 1 };
        }
        else if ($scope.ByWho2 == "OTHER") {
            $scope.newobj.Cladding.Insulation = { Description: $scope.ByWho2, ID: 1 };
        }
        else if ($scope.ByWho2 == "ZS") {
            $scope.newobj.Cladding.Insulation = { Description: "", ID: 1 };
        }
    };

    $scope.NSWByWhoChange = function () {
        if ($scope.ByWho1 == "ZS") {
            $scope.newobj.Cladding.Panel = { Description: "", Id: 1 };
        }
        else if ($scope.ByWho1 == "OTHER" || $scope.ByWho1 == "NONE") {
            $scope.newobj.Cladding.Panel = { Description: $scope.ByWho1, Id: 1 };
        }
    };
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.Subsystems.Partitions.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.Subsystems.Partitions.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.Subsystems.Partitions.Remarks.Remark)
            id = $scope.building.Subsystems.Partitions.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.Subsystems.Partitions.Remarks.Remark)
            $scope.building.Subsystems.Partitions.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.Subsystems.Partitions.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.Subsystems.Partitions.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.Subsystems.Partitions.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

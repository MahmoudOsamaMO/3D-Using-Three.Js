...
app.controller('PrimaryCtrl', function ($scope, $http,$log) {
    ...
    $scope.removeCoat = function (index) {
        ...
        $scope.Coathistory.push($scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat[index]);
        // Remove from main records (using index)
        $scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoCoat = function () {
        $scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat.push($scope.Coathistory[$scope.Coathistory.length - 1]);
    ...
    $scope.ResetCoat = function () {
        $scope.Coatword = "Add";
        var id = 1;
        if ($scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat)
            id = $scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat.length + 1;
        $scope.newCoat = {
            ID: id,
            By_Who: "ZS AT SHOP",
            Color: "",
    ...
    $scope.AddCoat = function () {
        if ($scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat)
            $scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat.push(angular.copy($scope.newCoat));
        else
            $scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat = [angular.copy($scope.newCoat)];
    };
    $scope.CoatUpdate = function (index) {
        $scope.newCoat = angular.copy($scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat[index]);
    ...
    $scope.ModyfyCoat = function () {
        $scope.building.SurfaceTreatment.PrimaryMembers.Coats.Coat[$scope.CoatIndex] = angular.copy($scope.newCoat);
    };
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark)
            id = $scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark)
            $scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.SurfaceTreatment.PrimaryMembers.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

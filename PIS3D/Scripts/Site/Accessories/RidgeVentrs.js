...
app.controller('GravityRidgeVentillatorCtrl', function ($scope, $http,$log) {
    ...
    $scope.AccName = "Gravity Ridge Ventillator";
    ...
    $scope.removeAcc = function (index) {
        ...
        $scope.Acchistory.push($scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator[index]);
        // Remove from main records (using index)
        $scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoAcc = function () {
        $scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator.push($scope.Acchistory[$scope.Acchistory.length - 1]);
    ...
    $scope.ResetAcc = function () {
        $scope.Accword = "Add";
        var id = 1;
        if ($scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator)
            id = $scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator.length + 1;
        $scope.newobj = {
            AssignTo: "Roof",
            Damper: "WITHOUT",
            Height: 0,
    ...
    $scope.AddAcc = function () {
        if ($scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator)
            $scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator.push($scope.newobj);
        else
            $scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator = [$scope.newobj];
    };
    $scope.AccUpdate = function (index) {
        $scope.newobj = angular.copy($scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator[index]);
        $scope.accIndex = index;
        $('#AccModal').modal('show');
        $scope.Accword = "Update";
        if ($scope.newobj.ShipAs)
            $scope.showadv = true;
    };
    ...
    $scope.ModyfyAcc = function () {
        $scope.building.Openings.GravityRidgeVentillators.GravityRidgeVentillator[$scope.accIndex] = angular.copy($scope.newobj);
    };
    ...
    $scope.AdvancedFunc = function () {
        $scope.newobj.Damper = "WITHOUT";
        $scope.newobj.Installation = "SINGLE";
        $scope.newobj.ShipAs = "KNOCKED DOWN";
        $scope.newobj.Throat = 300;
        $scope.newobj.MaterialDescription = "";
    };

    $scope.Dampers = ["WITHOUT", "WITH","NONE"];
    $scope.Installations = ["SINGLE", "CONTINUOUS", "NONE"];
    $scope.ShipAss = ["KNOCKED DOWN", "ASSEMBLED", "NONE"];
    $scope.Throats = [300,600];
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.Openings.GravityRidgeVentillators.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.Openings.GravityRidgeVentillators.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.Openings.GravityRidgeVentillators.Remarks.Remark)
            id = $scope.building.Openings.GravityRidgeVentillators.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.Openings.GravityRidgeVentillators.Remarks.Remark)
            $scope.building.Openings.GravityRidgeVentillators.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.Openings.GravityRidgeVentillators.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.Openings.GravityRidgeVentillators.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.Openings.GravityRidgeVentillators.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

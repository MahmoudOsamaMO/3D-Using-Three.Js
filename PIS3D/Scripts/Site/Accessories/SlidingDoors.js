...
app.controller('SlidingDoorsCtrl', function ($scope, $http,$log) {
    ...
    $scope.removeAcc = function (index) {
        ...
        $scope.Acchistory.push($scope.building.Openings.SlidingDoors.SlidingDoor[index]);
        // Remove from main records (using index)
        $scope.building.Openings.SlidingDoors.SlidingDoor.splice(index, 1);
    };
    // Undo action (delete)
    $scope.UndoAcc = function () {
        $scope.building.Openings.SlidingDoors.SlidingDoor.push($scope.Acchistory[$scope.Acchistory.length - 1]);
    ...
    $scope.ResetAcc = function () {
        $scope.Accword = "Add";
        var id = 1;
        if ($scope.building.Openings.SlidingDoors.SlidingDoor)
            id = $scope.building.Openings.SlidingDoors.SlidingDoor.length + 1;
        $scope.newobj = {
            AssignTo: "NSW",
            ExteriorPanel: { PanelType: "NONE" },
            Height: 0,
            ID: id,
    ...
    $scope.AddAcc = function () {
        if ($scope.building.Openings.SlidingDoors.SlidingDoor)
            $scope.building.Openings.SlidingDoors.SlidingDoor.push(angular.copy($scope.newobj));
        else
            $scope.building.Openings.SlidingDoors.SlidingDoor = [angular.copy($scope.newobj)];
    };
    $scope.AccUpdate = function (index) {
        $scope.newobj = angular.copy($scope.building.Openings.SlidingDoors.SlidingDoor[index]);
    ...
    $scope.ModyfyAcc = function () {
        $scope.building.Openings.SlidingDoors.SlidingDoor[$scope.accIndex] = angular.copy($scope.newobj);
    };
    ...
    $scope.AddSingleSkin = function () {
        ...
        if ($scope.SingleSkinFlag == 0)
            ...
            $scope.newobj.ExteriorPanel.PanelProfile.Panel.PanelProfile = { Description: $scope.newSkinobj.Description, Id: IDc };
        else if ($scope.SingleSkinFlag == 7)
            $scope.newobj.ExteriorPanel.PanelProfile.Liner.Liner = { Description: $scope.newSkinobj.Description, Id: IDc };
    ...
    $scope.AddTempcon = function () {
        ...
        if ($scope.SingleSkinFlag == 0)
            ...
            $scope.newobj.ExteriorPanel.PanelProfile.Panel.PanelProfile = { Description: $scope.newTempcon.Description, Id: IDc };
        else if ($scope.SingleSkinFlag == 7)
            $scope.newobj.ExteriorPanel.PanelProfile.Liner.Liner = { Description: $scope.newTempcon.Description, Id: IDc };
        else if ($scope.SingleSkinFlag == 8)
    ...
    $scope.RestSingleWallPanelNSW = function () {
        ...
        $scope.RestSingle($scope.newobj.ExteriorPanel.PanelProfile.Panel.PanelProfile);
    };
    $scope.RestTempconWallPanelNSW = function () {
        $scope.TempconType = ["TCSQ", "TCSO", "TCSM", "TCSN"];
        $scope.SingleSkinFlag = 6;
        $scope.RestTempcon($scope.newobj.ExteriorPanel.PanelProfile.Panel.PanelProfile);
    };

    $scope.RestSingleWallLinerNSW = function () {
        $scope.Profile = ["S", "ZW", "D", "E"];
        $scope.SingleSkinFlag = 7;
        $scope.RestSingle($scope.newobj.ExteriorPanel.PanelProfile.Liner.Liner);
    };
    $scope.RestTempconWallLinerNSW = function () {
        $scope.TempconType = ["TCSQ", "TCSO", "TCSM", "TCSN"];
        $scope.SingleSkinFlag = 7;
        $scope.RestTempcon($scope.newobj.ExteriorPanel.PanelProfile.Liner.Liner);
    };
    ...
    $scope.WallLinerNSWByWho = function () {
        if ($scope.newobj.ExteriorPanel.PanelProfile.Liner.ByWho == "NONE") {
            $scope.newobj.ExteriorPanel.PanelProfile.Liner = { ByWho: "NONE" };
        }
        else if ($scope.newobj.ExteriorPanel.PanelProfile.Liner.ByWho == "OTHER") {
            $scope.newobj.ExteriorPanel.PanelProfile.Liner = { ByWho: "OTHER", Weight: 0 };
        }
        else if ($scope.newobj.ExteriorPanel.PanelProfile.Liner.ByWho == "ZS") {
            $scope.newobj.ExteriorPanel.PanelProfile.Liner = { ByWho: "ZS", Liner: null };
        }
    };

    $scope.NSWByWhoChange = function () {
        if ($scope.newobj.ExteriorPanel.PanelProfile.Panel.ByWho == "ZS") {
            $scope.newobj.ExteriorPanel.PanelProfile.Panel.PanelProfile = [{ Description: "", Id: 0 }];
        }
        else if ($scope.newobj.ExteriorPanel.PanelProfile.Panel.ByWho == "OTHER") {
            //$scope.newobj.ExteriorPanel.PanelProfile.Panel.Weight = 0;
        }
    };
    ...
    $scope.removeRemark = function (index) {
        ...
        $scope.building.Openings.SlidingDoors.Remarks.Remark[index].State = "false";
    };
    // Undo action (delete)
    $scope.UndoRemark = function () {
        $scope.building.Openings.SlidingDoors.Remarks.Remark.push($scope.Remarkhistory[$scope.Remarkhistory.length - 1]);
    ...
    $scope.ResetRemark = function () {
        $scope.Remarkword = "Add";
        var id = 1;
        if ($scope.building.Openings.SlidingDoors.Remarks.Remark)
            id = $scope.building.Openings.SlidingDoors.Remarks.Remark.length + 1;
        $scope.newRemark = {
            ID: id,
            Remark: "",
            State: "true"
    ...
    $scope.AddRemark = function () {
        if ($scope.building.Openings.SlidingDoors.Remarks.Remark)
            $scope.building.Openings.SlidingDoors.Remarks.Remark.push(angular.copy($scope.newRemark));
        else
            $scope.building.Openings.SlidingDoors.Remarks.Remark = [angular.copy($scope.newRemark)];
    };
    $scope.RemarkUpdate = function (index) {
        $scope.newRemark = angular.copy($scope.building.Openings.SlidingDoors.Remarks.Remark[index]);
    ...
    $scope.ModyfyRemark = function () {
        $scope.building.Openings.SlidingDoors.Remarks.Remark[$scope.RemarkIndex] = angular.copy($scope.newRemark);
    };

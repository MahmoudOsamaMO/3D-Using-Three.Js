...
GO
PRINT N'Rename refactoring operation with key 3cca5064-d667-4b30-8547-ffd4f0dec0b5 is skipped, element [dbo].[SurfaceFinishTable].[Id] (SqlSimpleColumn) will not be renamed to SurfaceFinish_ID';


GO
PRINT N'Rename refactoring operation with key 71ebba0b-ff0d-4a0f-a323-49b4763a4278 is skipped, element [dbo].[SurfaceTreatmentTable].[Id] (SqlSimpleColumn) will not be renamed to SurfaceTreatment_ID';


GO
PRINT N'Rename refactoring operation with key d1ff03f7-a877-4e86-a5da-46283bb14054 is skipped, element [dbo].[PaintSystemTable].[Id] (SqlSimpleColumn) will not be renamed to PaintSystem_ID';


GO
PRINT N'Rename refactoring operation with key c922a153-13fc-4041-88c5-2017c4307701 is skipped, element [dbo].[SecondarySurfaceFinishTable].[Id] (SqlSimpleColumn) will not be renamed to SecondarySurfaceFinish_ID';


GO
PRINT N'Creating [dbo].[PaintSystemTable]...';
...
GO
CREATE TABLE [dbo].[PaintSystemTable] (
    [PaintSystem_ID] INT            IDENTITY (1, 1) NOT NULL,
    [PaintSystem]    NVARCHAR (MAX) NULL,
    PRIMARY KEY CLUSTERED ([PaintSystem_ID] ASC)
);
...
GO
PRINT N'Creating [dbo].[SecondarySurfaceFinishTable]...';
...
GO
CREATE TABLE [dbo].[SecondarySurfaceFinishTable] (
    [SecondarySurfaceFinish_ID] INT            IDENTITY (1, 1) NOT NULL,
    [SecondarySurfaceFinish]    NVARCHAR (MAX) NULL,
    PRIMARY KEY CLUSTERED ([SecondarySurfaceFinish_ID] ASC)
);
...
GO
PRINT N'Creating [dbo].[SurfaceFinishTable]...';
...
GO
CREATE TABLE [dbo].[SurfaceFinishTable] (
    [SurfaceFinish_ID] INT            IDENTITY (1, 1) NOT NULL,
    [SurfaceFinish]    NVARCHAR (MAX) NULL,
    PRIMARY KEY CLUSTERED ([SurfaceFinish_ID] ASC)
);
...
GO
PRINT N'Creating [dbo].[SurfaceTreatmentTable]...';
...
GO
CREATE TABLE [dbo].[SurfaceTreatmentTable] (
    [SurfaceTreatment_ID] INT            IDENTITY (1, 1) NOT NULL,
    [SurfaceTreatment]    NVARCHAR (MAX) NULL,
    PRIMARY KEY CLUSTERED ([SurfaceTreatment_ID] ASC)
);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '3cca5064-d667-4b30-8547-ffd4f0dec0b5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('3cca5064-d667-4b30-8547-ffd4f0dec0b5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '71ebba0b-ff0d-4a0f-a323-49b4763a4278')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('71ebba0b-ff0d-4a0f-a323-49b4763a4278')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd1ff03f7-a877-4e86-a5da-46283bb14054')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d1ff03f7-a877-4e86-a5da-46283bb14054')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c922a153-13fc-4041-88c5-2017c4307701')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c922a153-13fc-4041-88c5-2017c4307701')

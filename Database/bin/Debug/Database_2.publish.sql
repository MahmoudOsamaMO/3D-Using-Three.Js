...
GO
PRINT N'Rename refactoring operation with key d7dc56b4-77f5-42e5-8bb2-d562efabc521 is skipped, element [dbo].[BracingTypeTable].[Id] (SqlSimpleColumn) will not be renamed to BracingType_ID';


GO
PRINT N'Creating [dbo].[BracingTypeTable]...';
...
GO
CREATE TABLE [dbo].[BracingTypeTable] (
    [BracingType_ID] INT        IDENTITY (1, 1) NOT NULL,
    [BracingType]    NCHAR (10) NULL,
    PRIMARY KEY CLUSTERED ([BracingType_ID] ASC)
);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd7dc56b4-77f5-42e5-8bb2-d562efabc521')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d7dc56b4-77f5-42e5-8bb2-d562efabc521')
